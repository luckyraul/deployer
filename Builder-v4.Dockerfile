...
ENV VAULT_VERSION=1.21.4 WAYPOINT_VERSION=0.10.5 NOMAD_VERSION=1.9.7 LEVANT_VERSION=0.4.0 NOMADPACK_VERSION=0.1.0 GLIBC_VERSION=2.34-r0
...
RUN wget -q https://releases.hashicorp.com/waypoint/${WAYPOINT_VERSION}/waypoint_${WAYPOINT_VERSION}_linux_amd64.zip && \
    unzip -o waypoint_${WAYPOINT_VERSION}_linux_amd64.zip && \
